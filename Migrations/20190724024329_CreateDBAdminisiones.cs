...
{
    public partial class CreateDBAdminisiones : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorreoPrimario = table.Column<string>(nullable: true),
                    CorreoSecundario = table.Column<string>(nullable: true),
                    TipoIdentificacion = table.Column<string>(nullable: true),
                    NumeroIdentificacion = table.Column<string>(nullable: true),
                    Celular = table.Column<string>(nullable: true),
                    TelefonoPrimario = table.Column<string>(nullable: true),
                    TelefonoSecundario = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Direccion_PerfilUsuarios_PerfilusuarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Provincia_Direccion_DireccionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sector_Provincia_ProvinciaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Direccion_PerfilusuarioId",
                table: "Direccion",
                column: "PerfilusuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_Provincia_DireccionId",
                table: "Provincia",
                column: "DireccionId");

            migrationBuilder.CreateIndex(
                name: "IX_Sector_ProvinciaId",
                table: "Sector",
                column: "ProvinciaId");
        }
